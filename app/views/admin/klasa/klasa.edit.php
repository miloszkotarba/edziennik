...
Page::displayHeader("e-Dziennik Edycja klasy", "oceny.css");
...
?>
    <main>
        ...
        <div class="category-form">
            <?php if($result != 0) {
                echo <<< END
                <form action="/oddzial/edytuj" method="post" style="max-width: 40%">
                <label for="name">Nazwa oddziału</label>
                <input type="text" name="name" value="$klasaName">
                <p>Wychowawca</p>
                ...
                <input type="hidden" value="$link" name="klasaId">
