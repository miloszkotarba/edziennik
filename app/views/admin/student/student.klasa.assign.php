    ...
    <main>
        <div class="links-box" style="padding: 30px">
            <div class="header">
                <h2 id="page-title">
                    ...
                    <span>Przypisywanie uczniów do klas</span>
                </h2>
            </div>
        </div>
        ...
        <div class="links-box">
            ...
            <td style="text-align: right">
                <a style=" margin-right: 20px" href="class/$item->klasaId" title="Przypisz użytkowników"><i class="las la-user-check" style="color: #283e7a;"></i></a>
            </td>
            </tr>
            END;
                }
